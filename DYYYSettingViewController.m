...
- (void)setupSettingItems {
    self.settingSections = @[
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"时长纵轴位置" key:@"DYYYTimelineVerticalPosition" type:DYYYSettingItemTypeTextField placeholder:@"默认为15"],
            ...
            [DYYYSettingItem itemWithTitle:@"评论玻璃调节" key:@"DYYYCommentBlurtransparent" type:DYYYSettingItemTypeTextField placeholder:@"0-1的小数"],
            ...
            [DYYYSettingItem itemWithTitle:@"清理缓存加强" key:@"DYYYCleanCache" type:DYYYSettingItemTypeSwitch],
        ...
        @[
            [DYYYSettingItem itemWithTitle:@"设置顶栏透明" key:@"DYYYtopbartransparent" type:DYYYSettingItemTypeTextField placeholder:@"0-1的小数"],
            [DYYYSettingItem itemWithTitle:@"设置全局透明" key:@"DYYYGlobalTransparency" type:DYYYSettingItemTypeTextField placeholder:@"0-1的小数"],
            [DYYYSettingItem itemWithTitle:@"右侧按钮缩放" key:@"DYYYElementScale" type:DYYYSettingItemTypeTextField placeholder:@"不填默认"],
        ...
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"隐藏左下昵称" key:@"DYYYHidenc" type:DYYYSettingItemTypeSwitch],
            [DYYYSettingItem itemWithTitle:@"隐藏挑战提示" key:@"DYYYHidetz" type:DYYYSettingItemTypeSwitch],
        ],
        @[
        ...
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"启用双击打开评论" key:@"DYYYEnableDoubleTapComment" type:DYYYSettingItemTypeSwitch],
...
- (void)setupFooterLabel {
    ...
    self.footerLabel.text = [NSString stringWithFormat:@"开发者:花米\n插件版本: %@", @"2.1-7"];
